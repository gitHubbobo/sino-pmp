...
<link href="<%=cxp %>/css/style.css" rel="stylesheet" type="text/css" />
<script language="JavaScript" src="<%=cxp %>/js/jquery.js"></script>
<script src="<%=cxp %>/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#df7611; background-image:url(<%=cxp %>/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    ...
    <div class="loginbox">
    	<form action="<%=cxp %>/login/toMain" method="post">
    	<ul>
		    ...
		    <li><input name="" type="button" class="loginbtn" value="登录"  onclick="javascript:submit();"  />
